...
/*	https://github.com/m-y-l-e-s	*/

#region WHAT IS IT?
/*
__Struct is used to create the most true-to-form struct* data type possible**
...
**This will, of course, be obsoleted when Lightweight Objects are added as
	per https://www.yoyogames.com/blog/514/gml-updates-in-2019
*/
#endregion
...
Your created struct will by default contain 3 extra variables.  DO NOT MODIFY
THESE VARIABLES, THINGS WILL BREAK.
...
change scripts:
	...
	_room_goto(numb);
*/
#region Why do I need to use those scripts?
/*
...
#region WHAT ARE THE LIMITATIONS?
/*
